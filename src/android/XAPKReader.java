...
public class XAPKReader extends CordovaPlugin {
    ...
    public void initialize(final CordovaInterface cordova, CordovaWebView webView) {
        ...
        int patchVersionId = cordova.getActivity().getResources().getIdentifier("xapk_patch_version", "integer", cordova.getActivity().getPackageName());
        patchVersion = cordova.getActivity().getResources().getInteger(patchVersionId);

        int fileSizeId = cordova.getActivity().getResources().getIdentifier("xapk_patch_file_size", "integer", cordova.getActivity().getPackageName());
